...
extension DartStyleName on String {
  ...
  @visibleForTesting
  static final Iterable<String> dartReservedPropertyKeywords = Keyword.values.where((element) => element.isReservedWord).map((e) => e.lexeme.toLowerCase());
  ...
  String toDartPropertyName() {
    if (prismaWhereReservedKeywords.map((e) => e.toUpperCase()).contains(this)) {
      return this;
    }
